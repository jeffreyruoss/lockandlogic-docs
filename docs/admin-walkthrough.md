...
A step-by-step, screen-by-screen tour of your admin dashboard — the private control panel where you manage parts of the website yourself, no developer needed.

It lives at **lockandlogic.com/admin** and is protected by a password. This page walks through every screen with screenshots so you always know where things are.

> Looking for the short version? The [Admin Dashboard overview](/admin-dashboard) covers the basics. This page is the full visual guide.
